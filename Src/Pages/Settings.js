...
Actions.About();
  ...
  return (
    <View>
      ...
      <TouchableOpacity style={{flexDirection:'row',marginLeft:10,marginTop:10}}>
      <Feather name="globe" size={20} color="#004B87" />
      ...
      <Feather name="info" size={20} color="#004B87" />
      ...
      <AntDesign name="contacts" size={24} color="#004B87" />
      ...
      <TouchableOpacity style={{flexDirection:'row',marginLeft:10,marginTop:10}}>
      <Ionicons name="ios-contact" size={24} color="#004B87" />
      <Text style={styles.innertext}>Name :John Doe</Text>
      <AntDesign style={{right:5, position:'absolute'}} name="right" size={16} color="gray" />
      </TouchableOpacity>
      <TouchableOpacity style={{flexDirection:'row',marginLeft:10,marginTop:10}}>
      <Feather name="help-circle" size={20} color="#004B87" />
      ...
      <TouchableOpacity style={{flexDirection:'row',marginLeft:10,marginTop:10}}>
      <AntDesign name="notification" size={24} color="#004B87" />
      <Text style={styles.innertext}>App feedback</Text>
      <AntDesign style={{right:5, position:'absolute'}} name="right" size={16} color="gray" />
      </TouchableOpacity>
      <TouchableOpacity style={{flexDirection:'row',marginLeft:10,marginTop:10}}>
      <Entypo name="bug" size={24} color="#004B87" />
      ...
      <TouchableOpacity style={{flexDirection:'row',marginLeft:10,marginTop:10}}>
      <AntDesign name="lock" size={24} color="#004B87" />
      <Text style={styles.innertext}>Privacy</Text>
      <AntDesign style={{right:5, position:'absolute'}} name="right" size={16} color="gray" />
      </TouchableOpacity>
      <TouchableOpacity style={{flexDirection:'row',marginLeft:10,marginTop:10}}>
      <MaterialCommunityIcons name="license" size={24} color="#004B87" />
      <Text style={styles.innertext}>License</Text>
      <AntDesign style={{right:5, position:'absolute'}} name="right" size={16} color="gray" />
      </TouchableOpacity>
      <TouchableOpacity style={{flexDirection:'row',marginLeft:10,marginTop:10}}>
      <MaterialIcons name="security" size={24} color="#004B87" />
